...
const initialLeads: Lead[] = [
    { id: 'lead-1', company: 'Nova Retail', contactPerson: 'Ana Dumitru', contact: 'ana@novaretail.ro', source: 'Website', interest: 'Magazin online', estimatedValue: '18,400 RON', status: 'Nou' },
    { id: 'lead-2', company: 'DataMind SRL', contactPerson: 'Mihai Preda', contact: '0744 120 900', source: 'Campanie', interest: 'Automatizare', estimatedValue: '32,000 RON', status: 'Contactat' }
];

const initialOrders: Order[] = [
    { id: 'order-1', customer: 'Tech Solutions SRL', orderNumber: 'CMD-2026-018', products: 'CRM + training echipă', value: '24,500 RON', deliveryDate: '30 Iun 2026', status: 'Confirmată' },
    { id: 'order-2', customer: 'Global Finance SA', orderNumber: 'CMD-2026-019', products: 'Automatizare ERP', value: '42,000 RON', deliveryDate: '08 Iul 2026', status: 'În lucru' }
];

const initialCustomers: Customer[] = [
    { id: 'customer-1', company: 'Global Finance SA', fiscalCode: 'RO18490022', contactPerson: 'Ioan Ionescu', email: 'ioan@globalfinance.ro', phone: '021 400 300', type: 'Activ', totalContractsValue: '52,000 RON' },
    { id: 'customer-2', company: 'Brightech Inc.', fiscalCode: 'RO22910488', contactPerson: 'Elena Marin', email: 'elena@brightech.ro', phone: '0730 800 120', type: 'Prospect', totalContractsValue: '12,000 RON' }
];

const initialInvoices: Invoice[] = [
    { id: 'invoice-1', documentType: 'Factură', number: 'FCT-2026-001', client: 'Brightech Inc.', description: 'Licență CRM anuală', value: '12,000 RON', vat: '19%', dueDate: '12 Iun 2026', status: 'Plătită' },
    { id: 'invoice-2', documentType: 'Proformă', number: 'PRO-2026-014', client: 'WebDesign Pro', description: 'Landing page builder', value: '5,500 RON', vat: '19%', dueDate: '18 Iun 2026', status: 'Proformă' },
    { id: 'invoice-3', documentType: 'Factură', number: 'FCT-2026-003', client: 'DataMind SRL', description: 'Automatizări ERP', value: '22,300 RON', vat: '19%', dueDate: '25 Iun 2026', status: 'Restantă' }
];

const initialInventory: InventoryItem[] = [
    { id: 'stock-1', productName: 'Laptop Carbon X', sku: 'LCX-14-PRO', category: 'Hardware', quantity: 42, minimumStock: 10, supplier: 'Nord Supply' },
    { id: 'stock-2', productName: 'Monitor UltraWide', sku: 'MUW-34', category: 'Hardware', quantity: 8, minimumStock: 12, supplier: 'Display Hub' },
    { id: 'stock-3', productName: 'Licență AI Flow', sku: 'AIF-TEAM', category: 'Software', quantity: 126, minimumStock: 30, supplier: 'WorkflowsAI' }
];

const initialExpenses: Expense[] = [
    { id: 'expense-1', type: 'Cloud hosting', supplier: 'DataCenter Pro', value: '3,200 RON', date: '20 Iun 2026', paymentStatus: 'Programată', costCenter: 'Operațional' },
    { id: 'expense-2', type: 'Campanie PPC', supplier: 'Ads Studio', value: '6,800 RON', date: '21 Iun 2026', paymentStatus: 'Neplătită', costCenter: 'Marketing' },
    { id: 'expense-3', type: 'Curierat', supplier: 'FastShip', value: '1,780 RON', date: '24 Iun 2026', paymentStatus: 'Plătită', costCenter: 'Vânzări' }
];

const ecommerceBlocks: BuilderBlock<EcommerceBlockId>[] = [
    { id: 'header', label: 'Header', hint: 'Logo, navigație, coș', settings: { Logo: 'NordicTech', Meniu: 'Produse, Oferte, Suport', 'Badge coș': '3 produse' } },
